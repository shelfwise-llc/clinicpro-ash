defmodule Clinicpro.Accounts.AuthUserToken do
  @moduledoc """
  Schema for user tokens in the authentication system.
  ...
  schema "auth_user_tokens" do
    ...
    belongs_to :user, Clinicpro.Accounts.AuthUser, foreign_key: :user_id, type: :binary_id
  ...
  def verify_session_token_query(token) do
    query =
      from token in token_and_context_query(token, "session"),
        join: user in Clinicpro.Accounts.AuthUser,
  ...
  def token_and_context_query(token, context) do
    from Clinicpro.Accounts.AuthUserToken, where: [token: ^token, context: ^context]
  end
  ...
  def user_and_contexts_query(user, :all) do
    from t in Clinicpro.Accounts.AuthUserToken, where: t.user_id == ^user.id
  end
