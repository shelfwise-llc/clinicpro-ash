defmodule ClinicproWeb.PaystackAdminController do
  ...
  # Configurations
  def list_configs(conn, %{"clinic_id" => clinic_id}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  def new_config(conn, %{"clinic_id" => clinic_id}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  def create_config(conn, %{"clinic_id" => clinic_id, "config" => config_params}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  def edit_config(conn, %{"clinic_id" => clinic_id, "id" => id}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  # Subaccounts
  def list_subaccounts(conn, %{"clinic_id" => clinic_id}) do
    clinic_id = String.to_integer(clinic_id)
    subaccounts = Paystack.list_subaccounts(clinic_id)
  ...
  def new_subaccount(conn, %{"clinic_id" => clinic_id}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  def create_subaccount(conn, %{"clinic_id" => clinic_id, "subaccount" => subaccount_params}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  def edit_subaccount(conn, %{"clinic_id" => clinic_id, "id" => id}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  def activate_subaccount(conn, %{"clinic_id" => clinic_id, "id" => id}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  def delete_subaccount(conn, %{"clinic_id" => clinic_id, "id" => id}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  # Transactions
  def list_transactions(conn, %{"clinic_id" => clinic_id} = params) do
    clinic_id = String.to_integer(clinic_id)
  ...
  def verify_transaction(conn, %{"clinic_id" => clinic_id, "id" => id}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  # Test Payment
  def test_payment_form(conn, %{"clinic_id" => clinic_id}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  def create_test_payment(conn, %{"clinic_id" => clinic_id, "transaction" => transaction_params}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  # Webhook Logs
  def webhook_logs(conn, %{"clinic_id" => clinic_id} = params) do
    clinic_id = String.to_integer(clinic_id)
  ...
  def webhook_details(conn, %{"clinic_id" => clinic_id, "id" => id}) do
    clinic_id = String.to_integer(clinic_id)
  ...
  def retry_webhook(conn, %{"clinic_id" => clinic_id, "id" => id}) do
    clinic_id = String.to_integer(clinic_id)
