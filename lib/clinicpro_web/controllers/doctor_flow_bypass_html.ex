defmodule ClinicproWeb.DoctorFlowBypassHTML do
              ...
              <%= for appointment <- @appointments do %>
                <tr>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <a
                      href={~p"/doctor/appointments/#{appointment.id}"}
  ...
  def accessappointment(assigns) do
    ~H"""
    <div class="container mx-auto px-4 py-8">
      <div class="mb-6">
      ...
      <div class="bg-white shadow overflow-hidden rounded-lg">
        <div class="px-4 py-5 sm:px-6">
          ...
          <p class="mt-1 max-w-2xl text-sm text-gray-500">
            <%= Calendar.strftime(@appointment.date, "%B %d, %Y") %> at <%= Calendar.strftime(
              @appointment.time,
              "%H:%M"
            ) %>
          </p>
      ...
      <div class="mt-8">
        <a
          href={~p"/doctor/appointments/#{@appointment.id}/medical_details"}
          ...
          <div class="px-4 py-5 sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <input
                  type="text"
                  name="medical_details[blood_pressure]"
                  id="blood_pressure"
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <input
                  type="text"
                  name="medical_details[temperature]"
                  id="temperature"
                  class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                  required
                />
  ...
  def complete_appointment_form(assigns) do
    ...
    <div class="container mx-auto px-4 py-8">
      <div class="mb-6">
        <a
          href={~p"/doctor/appointments/#{@appointment.id}/diagnosis"}
          class="text-indigo-600 hover:text-indigo-900"
        >
