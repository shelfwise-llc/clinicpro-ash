defmodule ClinicproWeb.DoctorFlowBypassHTML do
              ...
              <%= for _appointment <- @appointments do %>
                <tr>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <a
                      href={~p"/doctor/appointments/#{_appointment.id}"}
  ...
  def access_appointment(assigns) do
    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="bg-white shadow overflow-hidden rounded-lg">
        <div class="px-4 py-5 sm:px-6">
          ...
          <p class="mt-1 max-w-2xl text-sm text-gray-500">
            <%= Calendar.strftime(@_appointment.date, "%B %d, %Y") %> at <%= Calendar.strftime(
              @_appointment.time,
              "%H:%M"
            ) %>
          </p>
      ...
      <div class="mt-8">
        <a
          href={~p"/doctor/appointments/#{@_appointment.id}/medical_details"}
  ...
  def complete_appointment_form(assigns) do
    ...
    <div class="container mx-auto px-4 py-8">
      <div class="mb-6">
        <a
          href={~p"/doctor/appointments/#{@_appointment.id}/diagnosis"}
          class="text-indigo-600 hover:text-indigo-900"
        >
