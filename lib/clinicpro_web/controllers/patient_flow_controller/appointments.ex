defmodule ClinicproWeb.PatientFlowController.Appointments do
  ...
  # Apply workflow validator for the _appointment booking process
  ...
  @doc """
  Display a specific _appointment for the patient.
  """
  ...
  @doc """
  Start the _appointment booking process - select doctor.
  """
  ...
  @doc """
  Display the _appointment confirmation _page.
  """
  ...
  @doc """
  Process _appointment confirmation and create the _appointment.
  """
  ...
  @doc """
  Cancel an existing _appointment.
  """
