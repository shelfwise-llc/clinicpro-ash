  ...
  defmacro doctor_flow_bypass_routes do
    quote do
      ...
      scope "/doctor", ClinicproWeb do
        ...
        # Medical details
        get "/appointments/:id/medical_details", DoctorFlowBypassController, :fill_medical_details_form
        post "/appointments/:id/medical_details", DoctorFlowBypassController, :fill_medical_details
