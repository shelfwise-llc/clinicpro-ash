defmodule ClinicproWeb.DoctorFlowIsolatedTest do
  ...
  setup do
    ...
    mock_accounts_api = fn ->
      %{
        get_user: fn _ -> {:ok, @mock_doctor} end,
        get_user_by_email: fn _ -> {:ok, @mock_doctor} end,
    ...
    mock_appointments_api = fn ->
      %{
        get_appointment: fn _ -> {:ok, @mock_appointment} end,
        list_appointments: fn _ -> {:ok, [@mock_appointment]} end,
        update_appointment: fn _, _ -> {:ok, @mock_appointment} end
      }
    end
