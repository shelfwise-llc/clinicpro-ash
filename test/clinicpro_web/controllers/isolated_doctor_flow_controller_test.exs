defmodule ClinicproWeb.IsolatedDoctorFlowControllerTest do
  ...
  describe "doctor flow" do
    ...
    test "GET /doctor/appointment/:id - renders appointment details", %{conn: conn, appointment: appointment} do
      # Setup connection with doctor user and workflow state
    ...
    test "GET /doctor/medical-details/:id - renders medical details form", %{conn: conn, appointment: appointment} do
      # Setup connection with doctor user and workflow state
      conn = setup_test_conn(conn, :doctor_flow, :fill_medical_details)
