defmodule ClinicproWeb.PatientFlowControllerTest do
  ...
  describe "patient flow" do
    test "GET /patient/receive-link/:token - validates token and redirects to welcome", %{
      conn: conn
    } do
      # Create a mock token
    ...
    test "POST /patient/confirm-details - processes confirmation and advances workflow", %{
      conn: conn
    } do
      # Setup session data
      appointment_data = %{
