defmodule ClinicproWeb.DoctorFlowControllerTest do
  ...
  describe "doctor flow" do
    ...
    test "GET /doctor/medical-details/:id - renders medical details form", %{conn: conn} do
      ...
      conn = setup_conn_with_user(conn, @mock_doctor, :doctor_flow, :fill_medical_details, %{
    ...
    test "POST /doctor/medical-details/:id - processes medical details and advances workflow", %{conn: conn} do
      # Authenticate the doctor and set up workflow state
      appointment_id = "appt-456"
      ...
      # Make the request
      conn = post(conn, ~p"/doctor/medical-details/#{appointment_id}", %{"medical_details" => medical_details})
    ...
    test "GET /doctor/diagnosis/:id - renders diagnosis form", %{conn: conn} do
      ...
      conn = setup_conn_with_user(conn, @mock_doctor, :doctor_flow, :record_diagnosis, %{
        appointment_id: appointment_id,
    ...
    test "GET /doctor/save-profile/:id - renders save profile page", %{conn: conn} do
      ...
      conn = setup_conn_with_user(conn, @mock_doctor, :doctor_flow, :complete_appointment, %{
        appointment_id: appointment_id,
        medical_details: medical_details,
        diagnosis: diagnosis
      })
