# Simple standalone script to test M-Pesa integration
# Run with: mix run test_mpesa.exs
...
defmodule MPesaTest do
  ...
  def run_stk_push_test do
    ...
    reference = "TEST-#{:rand.uniform(1_000_000)}"
    ...
    case Config.get_for_clinic(clinic_id) do
      ...
      {:error, _reason} ->
        ...
        attrs = %{
          ...
          "c2b_validation_url" =>
            System.get_env("MPESA_C2B_VALIDATION_URL") ||
              "https://example.com/mpesa/c2b/validation",
