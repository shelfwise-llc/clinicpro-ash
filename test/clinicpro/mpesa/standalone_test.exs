# Standalone M-Pesa Test Script
# Run with: elixir mpesa_standalone_test.exs
# This script doesn't require the Phoenix web components to compile

# Define a simple test module
defmodule MPesaStandaloneTest do
  def run do
