defmodule Clinicpro.MPesaModuleTest do
  ...
  describe "M-Pesa module fixes" do
    ...
    test "MockSTKPush with unused variable fixes" do
      ...
      assert {:ok, %{checkout_request_id: _unused, merchant_request_id: _unused}} = result

      # Test query_stk_push_status with unused variables
      status_result =
        MockSTKPush.query_stk_push_status("CHECKOUT123", "MERCHANT123", @clinic_1_id)

      assert {:ok, _unused} = status_result
    end
  end
end
