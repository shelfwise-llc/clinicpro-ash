defmodule Clinicpro.MPesa.CallbackInvoiceTest do
  ...
  describe "STK Push callbacks" do
    ...
    test "updates invoice status to paid when STK Push callback is successful", %{
      virtual_transaction: transaction,
      virtual_invoice: invoice
    } do
          ...
          "stkCallback" => %{
            ...
            "CallbackMetadata" => %{
              "Item" => [
                ...
                %{"Name" => "TransactionDate", "Value" => 20_230_601_121_212},
      ...
      updated_appointment =
        Clinicpro.AdminBypass.Appointment.get_appointment!(invoice.appointment_id)
    ...
    test "updates invoice status to paid when C2B callback is successful", %{
      onsite_transaction: transaction,
      onsite_invoice: invoice
    } do
    ...
    test "does not update invoice status when STK Push callback fails", %{
      virtual_transaction: transaction,
      virtual_invoice: invoice
    } do
