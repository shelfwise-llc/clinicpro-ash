defmodule Clinicpro.MPesaMultiTenantTest do
  ...
  # Test Clinic A
  @clinic_a_id "6ba7b810-9dad-11d1-80b4-00c04fd430c8"
  # Test Clinic B
  @clinic_b_id "6ba7b811-9dad-11d1-80b4-00c04fd430c8"
    ...
    if Code.ensure_loaded?(Clinicpro.MPesa.STKPush) do
      ...
      defmodule Clinicpro.MPesa.STKPush do
        def request(config, phone, amount, reference, description) do
          ...
          checkout_request_id =
            case config.clinic_id do
              "6ba7b810-9dad-11d1-80b4-00c04fd430c8" ->
                "ws_CO_A_#{DateTime.utc_now() |> DateTime.to_unix()}"

              "6ba7b811-9dad-11d1-80b4-00c04fd430c8" ->
                "ws_CO_B_#{DateTime.utc_now() |> DateTime.to_unix()}"

              _unused ->
                "ws_CO_#{DateTime.utc_now() |> DateTime.to_unix()}"
            end

          merchant_request_id =
            "#{:rand.uniform(100_000)}-#{:rand.uniform(100_000)}-#{config.clinic_id}"
    ...
    if Code.ensure_loaded?(Clinicpro.MPesa.C2B) do
      ...
      defmodule Clinicpro.MPesa.C2B do
        def register_urls(config) do
          ...
          conversation_id =
            case config.clinic_id do
              "6ba7b810-9dad-11d1-80b4-00c04fd430c8" -> "c2b-conv-A-#{:rand.uniform(100_000)}"
              "6ba7b811-9dad-11d1-80b4-00c04fd430c8" -> "c2b-conv-B-#{:rand.uniform(100_000)}"
              _unused -> "c2b-conv-#{:rand.uniform(100_000)}"
            end
