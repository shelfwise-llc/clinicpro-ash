...
defmodule Clinicpro.TestBypass.MockAuth do
  ...
  def verify_magic_link_token(token) do
    ...
    if email do
      {:ok, %Clinicpro.TestBypass.MockUser{id: Ecto.UUID.generate(), email: email, role: :patient}}
    else
      {:error, :invalid_token}
    end
  end
...
defmodule Clinicpro.TestBypass.MockAccountsAPI do
  ...
  @impl true
  def get_user(id) do
    {:ok, %Clinicpro.TestBypass.MockUser{
      id: id,
...
defmodule Clinicpro.TestBypass.MockAppointmentsAPI do
  ...
  def get_appointment(id) do
    {:ok, %Clinicpro.TestBypass.MockAppointment{
      id: id,
