defmodule ClinicproWeb.ControllerTestHelper do
  ...
  def maybe_sign_in_user(conn, :doctor),
    do: Clinicpro.AuthBypass.sign_in(conn, build_mock_doctor())

  def maybe_sign_in_user(conn, :admin), do: Clinicpro.AuthBypass.sign_in(conn, build_mock_admin())

  def maybe_sign_in_user(conn, :patient),
    do: Clinicpro.AuthBypass.sign_in(conn, build_mock_patient())

  def maybe_sign_in_user(conn, user_attrs) when is_map(user_attrs),
    do: Clinicpro.AuthBypass.sign_in(conn, user_attrs)
